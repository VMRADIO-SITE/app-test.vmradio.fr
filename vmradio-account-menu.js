...
#vm-account-home.open #vm-account-home-panel{max-height:420px;opacity:1;transform:translateY(0);pointer-events:auto;margin-top:8px}
...
.vm-account-actions{display:grid;gap:7px;margin-top:9px}.vm-account-action{width:100%;border:1px solid rgba(255,255,255,.08);border-radius:11px;background:rgba(255,255,255,.045);color:#fff;padding:10px 11px;text-align:left;font:800 10px Arial,sans-serif;cursor:pointer}.vm-account-action:hover{background:rgba(184,92,255,.11)}.vm-account-action.danger{color:#ffb9c5;border-color:rgba(255,90,120,.22)}
