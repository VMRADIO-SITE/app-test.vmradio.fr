...
// v51 : badge source fixé directement sur les pochettes + renouvellement du cache PWA.
const CACHE_NAME = "vm-radio-app-v51";
const APP_SHELL = [
  "./",
  "./index.html",
  "./dedicaces.html",
  ...
  "./player-source-badge.js?v=20260829-sourcebadge3",
    ...
    fetch(event.request, { cache: "no-store" }).then(async response => {
      ...
      if (url.pathname.endsWith("/index.html") || url.pathname === "/") {
        ...
        if (type.includes("text/html")) {
          ...
          injected = injected.replace(/vm-radio-flux-central\.js(?:\?[^"']*)?/gi, 'vm-radio-flux-central.js?v=20260829-sourcebadge3');
          injected = injected.replace(/player-source-badge\.js(?:\?[^"']*)?/gi, 'player-source-badge.js?v=20260829-sourcebadge3');
          ...
          if (!injected.includes("player-source-badge.js")) injected = injected.replace(/<\/body>/i, '<script src="./player-source-badge.js?v=20260829-sourcebadge3"></script></body>');
